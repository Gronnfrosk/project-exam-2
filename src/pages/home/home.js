...
function MainPage() {
  ...
  return (
    ...
    <header>
      ...
      <h1 id="booking" className="text-center mt-4">Available bookings</h1>
      </header>
      <main>
        <section>
      <Form className="search">
        <InputBase placeholder={" Search here..."} type={"text"} label={""} />
        <div className="search-icon">{SearchIcon}</div>
      </Form>
      </section>
      <div class="divider dropdown-toggle gap-2 ps-3">
				Recent
			</div>
      <section>
      <VenueCard />
