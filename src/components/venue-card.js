...
export default function VenueCard() {
    ...
    return <Card>
                <div className="part-1">
                    <Card.Img variant="top" src={mainTop} className="img-fluid rounded-0" alt="A specific venue"/>
                ...
                <Card.Body>
                    <div className="venue-description">
                        ...
                        <Card.Text className="pt-2">
                            ...
                            view over the city. This is 
                            a big Apartment in the 
                            city...</Card.Text>
                        <Card.Text className="rating mt-auto">Rating
                    ...
                    <div className="amenities">
                        ...
                        <Card.Text className="amenity-list">{WifiIcon} {ParkIcon} {BreakfastIcon} {PetIcon}</Card.Text>
                    </div>
                </Card.Body>
            </Card>
}